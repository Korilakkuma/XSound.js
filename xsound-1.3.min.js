...
function(a,b,h,c,d,e,g){if(!navigator.onLine)throw this.websocket=null,this.isActive=!1,Error("Now offline !!");if("[object Object]"===Object.prototype.toString.call(a)){var f=a;"tls"in f&&(a=f.tls);"host"in f&&(b=f.host);"port"in f&&(h=f.port);"path"in f&&(c=f.path);"open"in f&&(d=f.open);"close"in f&&(e=f.close);"error"in f&&(g=f.error)}a=a?"wss://":"ws://";"/"!==c.charAt(0)&&(c="/"+c);h=parseInt(h);if(!(isNaN(h)||0>h||65535<h)){this.websocket=new WebSocket(a+b+":"+h+c);this.websocket.binaryType=
"arraybuffer";var l=this;this.websocket.onopen=function(a){"[object Function]"===Object.prototype.toString.call(d)&&d(a,l.websocket)};this.websocket.onclose=function(a){"[object Function]"===Object.prototype.toString.call(e)&&e(a,l.websocket)};this.websocket.onerror=function(a){"[object Function]"===Object.prototype.toString.call(g)&&g(a,l.websocket)};this.websocket.onmessage=function(a){if(l.isActive){if(a.data instanceof ArrayBuffer){var c=Math.floor(a.data.byteLength/Float32Array.BYTES_PER_ELEMENT/
2),k=c*Float32Array.BYTES_PER_ELEMENT,b=new Float32Array(a.data,0,c),h=new Float32Array(a.data,k,c);l.receiver.connect(l.analyser.input);l.analyser.output.connect(l.context.destination);l.analyser.start("time");l.analyser.start("fft");l.receiver.onaudioprocess=function(a){var c=a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);c.set(b);a.set(h);l.isActive&&null!==l.websocket||(l.analyser.stop("time"),l.analyser.stop("fft"),this.disconnect(0),this.onaudioprocess=null)}}}else l.analyser.stop("time"),
l.analyser.stop("fft"),l.receiver.disconnect(0),l.receiver.onaudioprocess=null};return this}};l.prototype.start=function(){if(this.isActive&&this.isConnected()&&this.paused){this.paused=!1;var a=new Float32Array(2*this.sender.bufferSize),b=this;this.sender.onaudioprocess=function(h){if(b.isActive&&b.isConnected()){var c=h.inputBuffer.getChannelData(0);h=h.inputBuffer.getChannelData(1);for(var d=0;d<this.bufferSize;d++)a[d]=c[d],a[a.length/2+d]=h[d];b.websocket.send(a)}else b.paused=!0,b.sender.disconnect(0),
b.sender.onaudioprocess=null}}return this};l.prototype.close=function(){this.websocket instanceof WebSocket&&(this.websocket.close(),this.websocket=null);return this};l.prototype.isConnected=function(){return this.websocket instanceof WebSocket&&this.websocket.readyState===WebSocket.OPEN?!0:!1};l.prototype.state=function(a){if(void 0===a)return this.isActive;"toggle"===String(a).toLowerCase()?this.isActive=!this.isActive:this.isActive=Boolean(a);return this};l.prototype.toString=function(){return"[SoundModule Session]"};
