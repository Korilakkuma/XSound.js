...
("wave"===k&&"gradient"===d&&(this.styles.shape="rect"),this.styles[k]="font"===k?d:d.toLowerCase());break;case "width":case "top":case "right":case "bottom":case "left":if(void 0===d)return this.styles[k];b="width"===k?parseFloat(d):parseInt(d);0<=b&&(this.styles[k]=b)}};b.prototype.start=function(a,d,k){switch(this.drawType){case "canvas":this.drawToCanvas(a,d,k);break;case "svg":this.drawToSVG(a,d,k)}return this};b.prototype.create=function(){switch(this.drawType){case "canvas":return this.canvas.toDataURL("image/png").replace("image/png",
"image/octet-stream");case "svg":return this.svgParent.innerHTML;default:return this}};b.prototype.state=function(a){if(void 0===a)return this.isActive;"toggle"===String(a).toLowerCase()?this.isActive=!this.isActive:this.isActive=Boolean(a);return this};b.prototype.drawTimeDomainFloat32ArrayToCanvas=function(a,d,k,b,l,c){if(!(a instanceof CanvasRenderingContext2D&&d instanceof Float32Array))return this;var u=0,g=0;k=parseInt(k);var f=parseInt(b);l=parseInt(l);isNaN(k)&&(k=0);isNaN(f)&&(f=0);isNaN(l)&&
(l=0);switch(this.styles.shape){case "line":a.strokeStyle=this.styles.wave;a.lineWidth=this.styles.width;a.lineCap=this.styles.cap;a.lineJoin=this.styles.join;a.beginPath();for(var e=0,h=d.length;e<h;e++)if(void 0===c||0===e%c)u=Math.floor(e/h*k)+this.styles.left,g=Math.floor(f/2*(1-d[e]))+this.styles.top,0===e?a.moveTo(u,g):a.lineTo(u,g);a.stroke();break;case "rect":for("gradient"!==this.styles.wave&&(a.fillStyle=this.styles.wave),e=0,h=d.length;e<h;e++)if(void 0===c||0===e%c){u=Math.floor(e/h*k)+
this.styles.left;g=-1*Math.floor(f/2*d[e]);if("gradient"===this.styles.wave){for(var q=b/2+this.styles.top,q=a.createLinearGradient(0,q,0,q+g),m=0,r=this.styles.grad.length;m<r;m++){var p=this.styles.grad[m];q.addColorStop(p.offset,p.color)}a.fillStyle=q}a.fillRect(u,l,this.styles.width,g)}}return this};b.prototype.drawTimeDomainFloat32ArrayToSVG=function(a,d,k,b,l,c){var u="",g=0,e=0;k=parseInt(k);var f=parseInt(b);l=parseInt(l);isNaN(k)&&(k=0);isNaN(f)&&(f=0);isNaN(l)&&(l=0);switch(this.styles.shape){case "line":for(var u=
u+('<path style="'+a+'" d="'),h=0,q=d.length;h<q;h++)if(void 0===c||0===h%c)g=Math.floor(h/q*k)+this.styles.left,e=Math.floor(f/2*(1-d[h]))+this.styles.top,0===h?u+="M"+g+" "+e:(u+=" ",u+="L"+g+" "+e);u+='" />';break;case "rect":for(h=0,q=d.length;h<q;h++)if(void 0===c||0===h%c)g=Math.floor(h/q*k)+this.styles.left,e=Math.floor(b/2*d[h]),u+=0>e?'<rect style="'+a+'" x="'+g+'" y="'+l+'" width="'+this.styles.width+'" height="'+-e+'" />':'<rect style="'+a+'" x="'+g+'" y="'+l+'" width="'+this.styles.width+
...
2)+this.styles.top,g=0,e=0,f="",g=Math.floor(this.plotinterval*this.SAMPLE_RATE),e=Math.floor(this.textinterval*this.SAMPLE_RATE);d.clearRect(0,0,k,b);this.drawTimeDomainFloat32ArrayToCanvas(d,a,l,c,u,g);if("none"!==this.styles.grid||"none"!==this.styles.text){for(var u=0,h=a.length;u<h;u++)0===u%e&&(g=Math.floor(u/h*l)+this.styles.left,f=Math.floor(u/this.SAMPLE_RATE)+" min","none"!==this.styles.grid&&(d.fillStyle=this.styles.grid,d.fillRect(g,this.styles.top,1,c)),"none"!==this.styles.text&&(d.fillStyle=
this.styles.text,d.font=this.styles.font,d.fillText(f,g-d.measureText(f).width/2,b)));for(var q=["-1.00","-0.50"," 0.00"," 0.50"," 1.00"],u=0,h=q.length;u<h;u++)f=q[u],g=Math.floor(k-d.measureText(f).width),e=Math.floor((1-parseFloat(f.trim()))*(c/2))+this.styles.top,"none"!==this.styles.grid&&(d.fillStyle=this.styles.grid,d.fillRect(this.styles.left,e,l,1)),e-=parseInt(d.font.match(/\s*(\d+)px.*/)[1]/4),"none"!==this.styles.text&&(d.fillStyle=this.styles.text,d.font=this.styles.font,d.fillText(f,
g,e))}this.savedImage=d.getImageData(0,0,k,b);this.length=a.length;d.fillStyle=this.currentTime;d.fillRect(this.styles.left,this.styles.top,1,c);return this};l.prototype.drawToSVG=function(a){if(!(this.svg instanceof SVGElement&&this.svgParent instanceof HTMLElement&&this.isActive))return this;var d=this.svgParent.innerHTML.match(/(<svg[^<>]*>).*<\/svg>/)[1]+"</svg>",k=this.svg.getAttribute("width"),b=this.svg.getAttribute("height"),l=k-(this.styles.left+this.styles.right),u=b-(this.styles.top+this.styles.bottom),
c=Math.floor(u/2)+this.styles.top,g=0,e=0,f="",g=Math.floor(this.plotinterval*this.SAMPLE_RATE),e=Math.floor(this.textinterval*this.SAMPLE_RATE),f="";switch(this.styles.shape){case "line":f+="stroke : "+this.styles.wave+"; ",f=f+"fill : none; "+("stroke-width : "+this.styles.width+"; "),f+="stroke-linecap : "+this.styles.cap+"; ",f+="stroke-linejoin : "+this.styles.join+";";case "rect":if("gradient"===this.styles.wave){var h;h='<defs><linearGradient id="svg-linear-gradient" x1="0%" y1="0%" x2="0%" y2="100%">';
for(var q=0,m=this.styles.grad.length;q<m;q++){var r=this.styles.grad[q];h+='<stop offset="'+r.offset+'" stop-color="'+r.color+'" />'}h+="</linearGradient>";h+="</defs>";f+="stroke : none; ";f+="fill : url(#svg-linear-gradient); "}else f+="stroke : none; ",f+="fill : "+this.styles.wave+"; ";f+="stroke-width : 0;"}var r="stroke : none; "+("fill : "+this.styles.grid+"; "),r=r+"stroke-width : 0;",m=this.styles.font.match(/\s*(\d+)px (.*)/),q=m[2],p=m[1],n;n="stroke : none; "+("fill : "+this.styles.text+
...
(d+='<rect style="'+r+'" x="'+g+'" y="'+this.styles.top+'" width="1" height="'+u+'" />'),"none"!==this.styles.text&&(d+='<text text-anchor="middle" style="'+n+'" x="'+g+'" y="'+b+'">'+f+"</text>"));b=["-1.00","-0.50"," 0.00"," 0.50"," 1.00"];q=0;for(m=b.length;q<m;q++)f=b[q],g=k,e=Math.floor((1-parseFloat(f.trim()))*(u/2))+this.styles.top,"none"!==this.styles.grid&&(d+='<rect style="'+r+'" x="'+this.styles.left+'" y="'+e+'" width="'+l+'" height="1" />'),e-=Math.floor(parseInt(p)/4),"none"!==this.styles.text&&
(d+='<text text-anchor="end" style="'+n+'" x="'+g+'" y="'+e+'">'+f+"</text>")}d+='<rect class="svg-current-time" style="'+C+'" x="'+this.styles.left+'" y="'+this.styles.top+'" width="1" height="'+u+'" />';d+="</svg>";this.savedImage=this.svgParent.innerHTML=d;this.length=a.length;return this};l.prototype.update=function(a){switch(this.drawType){case "canvas":if(this.canvas instanceof HTMLCanvasElement&&this.isActive)break;else return;case "svg":if(!(this.svg instanceof SVGElement&&this.svgParent instanceof
...
0>d&&(d=0);d>b&&(d=b);b=d/b*this.length/this.SAMPLE_RATE;this.update(b);"[object Function]"===Object.prototype.toString.call(a)&&a(b)},c=function(a){if(a.pageX)return a.pageX;if(a.touches[0])return a.touches[0].pageX},f=!1,g=this;d.addEventListener(k,function(a){null!==g.savedImage&&(u.call(g,c(a)),f=!0)},!0);d.addEventListener(b,function(a){a.preventDefault();f&&null!==g.savedImage&&u.call(g,c(a))},!0);x.addEventListener(l,function(a){f&&(f=!1)},!0);return this};l.prototype.toString=function(){return"[SoundModule Analyser TimeAll]"};
...
d,k){if(!(this.canvas instanceof HTMLCanvasElement&&this.isActive))return this;parseFloat(d);parseFloat(k);d=this.context;k=this.canvas.width;var b=this.canvas.height,l=k-(this.styles.left+this.styles.right),u=b-(this.styles.top+this.styles.bottom),c=Math.floor(u/2)+this.styles.top,f=0,g=0,e="",h=Math.floor(this.textinterval*this.SAMPLE_RATE);d.clearRect(0,0,k,b);switch(this.type){case "float":this.drawTimeDomainFloat32ArrayToCanvas(d,a,l,u,c);break;default:switch(this.styles.shape){case "line":d.strokeStyle=
this.styles.wave;d.lineWidth=this.styles.width;d.lineCap=this.styles.cap;d.lineJoin=this.styles.join;d.beginPath();for(var q=0,m=a.length;q<m;q++)f=Math.floor(q/m*l)+this.styles.left,g=Math.floor((1-a[q]/255)*u)+this.styles.top,0===q?d.moveTo(f,g):d.lineTo(f,g);d.stroke();break;case "rect":for("gradient"!==this.styles.wave&&(d.fillStyle=this.styles.wave),q=0,m=a.length;q<m;q++){f=Math.floor(q/m*l)+this.styles.left;g=Math.floor((.5-a[q]/255)*u);if("gradient"===this.styles.wave){for(var e=u/2+this.styles.top,
e=d.createLinearGradient(0,e,0,e+g),r=0,n=this.styles.grad.length;r<n;r++){var p=this.styles.grad[r];e.addColorStop(p.offset,p.color)}d.fillStyle=e}d.fillRect(f,c,this.styles.width,g)}}}if("none"!==this.styles.grid||"none"!==this.styles.text){q=0;for(m=a.length;q<m;q++)0===q%h&&(f=Math.floor(q/m*l)+this.styles.left,e=Math.floor(q/this.SAMPLE_RATE*1E3)+" ms","none"!==this.styles.grid&&(d.fillStyle=this.styles.grid,d.fillRect(f,this.styles.top,1,u)),"none"!==this.styles.text&&(d.fillStyle=this.styles.text,
d.font=this.styles.font,d.fillText(e,f-d.measureText(e).width/2,b)));a=["-1.00","-0.50"," 0.00"," 0.50"," 1.00"];q=0;for(m=a.length;q<m;q++)e=a[q],f=Math.floor(k-d.measureText(e).width),g=Math.floor((1-parseFloat(e.trim()))*(u/2))+this.styles.top,"none"!==this.styles.grid&&(d.fillStyle=this.styles.grid,d.fillRect(this.styles.left,g,l,1)),g-=parseInt(d.font.match(/\s*(\d+)px.*/)[1]/4),"none"!==this.styles.text&&(d.fillStyle=this.styles.text,d.font=this.styles.font,d.fillText(e,f,g))}return this};d.prototype.drawToSVG=
...
"; ";e=e+"fill : none; "+("stroke-width : "+this.styles.width+"; ");e+="stroke-linecap : "+this.styles.cap+"; ";e+="stroke-linejoin : "+this.styles.join+";";break;case "rect":if("gradient"===this.styles.wave){var h;h='<defs><linearGradient id="svg-linear-gradient" x1="0%" y1="0%" x2="0%" y2="100%">';for(var m=0,r=this.styles.grad.length;m<r;m++){var p=this.styles.grad[m];h+='<stop offset="'+p.offset+'" stop-color="'+p.color+'" />'}h+="</linearGradient>";h+="</defs>";e+="stroke : none; ";e+="fill : url(#svg-linear-gradient); "}else e+=
"stroke : none; ",e+="fill : "+this.styles.wave+"; ";e+="stroke-width : 0;"}var p="stroke : none; "+("fill : "+this.styles.grid+"; "),p=p+"stroke-width : 0;",r=this.styles.font.match(/\s*(\d+)px (.*)/),m=r[2],n=r[1],C;C="stroke : none; "+("fill : "+this.styles.text+"; ");C+="font-family : "+m+"; ";C+="font-size : "+n+";";this.svgParent.innerHTML=d;d=this.svgParent.innerHTML.replace("</svg>","");"gradient"===this.styles.wave&&(d+=h);switch(this.type){case "float":d+=this.drawTimeDomainFloat32ArrayToSVG(e,
a,l,u,c);break;default:switch(this.styles.shape){case "line":d+='<path style="'+e+'" d="';m=0;for(r=a.length;m<r;m++)g=Math.floor(m/r*l)+this.styles.left,f=Math.floor((1-a[m]/255)*u)+this.styles.top,0===m?d+="M"+g+" "+f:(d+=" ",d+="L"+g+" "+f);d+='" />';break;case "rect":for(m=0,r=a.length;m<r;m++)g=Math.floor(m/r*l)+this.styles.left,f=Math.floor((a[m]/255-.5)*u),d+=0>f?'<rect style="'+e+'" x="'+g+'" y="'+c+'" width="'+this.styles.width+'" height="'+-f+'" />':'<rect style="'+e+'" x="'+g+'" y="'+c+
...
b+'">'+e+"</text>"));a=["-1.00","-0.50"," 0.00"," 0.50"," 1.00"];m=0;for(r=a.length;m<r;m++)e=a[m],g=k,f=Math.floor((1-parseFloat(e.trim()))*(u/2))+this.styles.top,"none"!==this.styles.grid&&(d+='<rect style="'+p+'" x="'+this.styles.left+'" y="'+f+'" width="'+l+'" height="1" />'),f-=Math.floor(parseInt(n)/4),"none"!==this.styles.text&&(d+='<text text-anchor="end" style="'+C+'" x="'+g+'" y="'+f+'">'+e+"</text>")}this.svgParent.innerHTML=d+"</svg>";return this};d.prototype.toString=function(){return"[SoundModule Analyser Time]"};
...
k=parseFloat(d);0<k&&(this.textinterval=k)}}return this};c.prototype.drawToCanvas=function(d,a,k){if(!(this.canvas instanceof HTMLCanvasElement&&this.isActive))return this;var b=parseFloat(a),l=parseFloat(k),u=l-b;k=this.context;a=this.canvas.width;var c=this.canvas.height,e=a-(this.styles.left+this.styles.right),g=c-(this.styles.top+this.styles.bottom),f=0,q=0,h="",m=this.size>d.length?d.length:this.size,r=Math.floor(this.textinterval/(this.SAMPLE_RATE/(2*d.length)));k.clearRect(0,0,a,c);switch(this.type){case "float":k.strokeStyle=
"gradient"!==this.styles.wave?this.styles.wave:"rgba(0, 0, 255, 1.0)";k.lineWidth=this.styles.width;k.lineCap=this.styles.cap;k.lineJoin=this.styles.join;k.beginPath();for(var p=0;p<m;p++)f=Math.floor(p/m*e)+this.styles.left,q=Math.abs(d[p]-l)*(g/u)+this.styles.top,0===p?k.moveTo(f,q):k.lineTo(f,q);k.stroke();break;default:switch(this.styles.shape){case "line":k.strokeStyle=this.styles.wave;k.lineWidth=this.styles.width;k.lineCap=this.styles.cap;k.lineJoin=this.styles.join;k.beginPath();for(p=0;p<
m;p++)f=Math.floor(p/m*e)+this.styles.left,q=Math.floor((1-d[p]/255)*g)+this.styles.top,0===p?k.moveTo(f,q):k.lineTo(f,q);k.stroke();break;case "rect":for("gradient"!==this.styles.wave&&(k.fillStyle=this.styles.wave),p=0;p<m;p++){f=Math.floor(p/m*e)+this.styles.left;q=-1*Math.floor(d[p]/255*g);if("gradient"===this.styles.wave){for(var h=g+this.styles.top,h=k.createLinearGradient(0,h,0,h+q),n=0,C=this.styles.grad.length;n<C;n++){var t=this.styles.grad[n];h.addColorStop(t.offset,t.color)}k.fillStyle=
h}k.fillRect(f,g+this.styles.top,this.styles.width,q)}}}if("none"!==this.styles.grid||"none"!==this.styles.text){for(p=d=0;p<m;p++)0===p%r&&(f=Math.floor(p/m*e)+this.styles.left,d=Math.floor(p/r*this.textinterval),h=1E3>d?d+" Hz":String(d/1E3).slice(0,3)+" kHz","none"!==this.styles.grid&&(k.fillStyle=this.styles.grid,k.fillRect(f,this.styles.top,1,g)),"none"!==this.styles.text&&(k.fillStyle=this.styles.text,k.font=this.styles.font,k.fillText(h,f-k.measureText(h).width/2,c)));switch(this.type){case "float":for(p=
b;p<=l;p+=10)h=p+"dB",f=a-Math.floor(k.measureText(h).width),q=Math.floor(-1*(p-l)/u*g)+this.styles.top,"none"!==this.styles.grid&&(k.fillStyle=this.styles.grid,k.fillRect(this.styles.left,q,e,1)),q-=parseInt(k.font.match(/\s*(\d+)px.*/)[1]/4),"none"!==this.styles.text&&(k.fillStyle=this.styles.text,k.font=this.styles.font,k.fillText(h,f,q));break;default:for(d=["0.00","0.25","0.50","0.75","1.00"],p=0,b=d.length;p<b;p++)h=d[p],f=a-Math.floor(k.measureText(h).width),q=(1-parseFloat(h))*g+this.styles.top,
"none"!==this.styles.grid&&(k.fillStyle=this.styles.grid,k.fillRect(this.styles.left,q,e,1)),q-=parseInt(k.font.match(/\s*(\d+)px.*/)[1]/4),"none"!==this.styles.text&&(k.fillStyle=this.styles.text,k.font=this.styles.font,k.fillText(h,f,q))}}return this};c.prototype.drawToSVG=function(d,a,k){if(!(this.svg instanceof SVGElement&&this.svgParent instanceof HTMLElement&&this.isActive))return this;a=parseFloat(a);var b=parseFloat(k),l=b-a;k=this.svgParent.innerHTML.match(/(<svg[^<>]*>).*<\/svg>/)[1]+"</svg>";
var u=this.svg.getAttribute("width"),c=this.svg.getAttribute("height"),f=u-(this.styles.left+this.styles.right),e=c-(this.styles.top+this.styles.bottom),g=0,q=0,h="",m=this.size>d.length?d.length:this.size,r=Math.floor(this.textinterval/(this.SAMPLE_RATE/(2*d.length))),h="";switch(this.styles.shape){case "line":h+="stroke : "+this.styles.wave+"; ";h=h+"fill : none; "+("stroke-width : "+this.styles.width+"; ");h+="stroke-linecap : "+this.styles.cap+"; ";h+="stroke-linejoin : "+this.styles.join+";";
...
this.svgParent.innerHTML=k;k=this.svgParent.innerHTML.replace("</svg>","");"uint"===this.type&&"gradient"===this.styles.wave&&(k+=p);switch(this.type){case "float":k+='<path style="'+h+'" d="';for(n=0;n<m;n++)g=Math.floor(n/m*f)+this.styles.left,q=Math.floor(e/l*(d[n]-b)*-1)+this.styles.top,0===n?k+="M"+g+" "+q:(k+=" ",k+="L"+g+" "+q);k+='" />';break;default:switch(this.styles.shape){case "line":k+='<path style="'+h+'" d="';for(n=0;n<m;n++)g=Math.floor(n/m*f)+this.styles.left,q=Math.floor((1-d[n]/
255)*e)+this.styles.top,0===n?k+="M"+g+" "+q:(k+=" ",k+="L"+g+" "+q);k+='" />';break;case "rect":for(n=0;n<m;n++)g=Math.floor(n/m*f)+this.styles.left,q=Math.floor(d[n]/255*e),k+='<rect style="'+h+'" x="'+g+'" y="'+(this.styles.top+e)+'" width="'+this.styles.width+'" height="'+q+'" transform="translate('+this.styles.width+" 0) rotate(180 "+g+" "+(this.styles.top+e)+')" />'}}if("none"!==this.styles.grid||"none"!==this.styles.text){for(n=d=0;n<m;n++)0===n%r&&(g=Math.floor(n/m*f)+this.styles.left,d=Math.floor(n/
r*this.textinterval),h=1E3>d?d+" Hz":String(d/1E3).slice(0,3)+" kHz","none"!==this.styles.grid&&(k+='<rect style="'+t+'" x="'+g+'" y="'+this.styles.top+'" width="1" height="'+e+'" />'),"none"!==this.styles.text&&(k+='<text text-anchor="middle" style="'+v+'" x="'+g+'" y="'+c+'">'+h+"</text>"));switch(this.type){case "float":for(n=a;n<=b;n+=10)h=n+"dB",g=u,q=Math.floor(-1*(n-b)/l*e)+this.styles.top,"none"!==this.styles.grid&&(k+='<rect style="'+t+'" x="'+this.styles.left+'" y="'+q+'" width="'+f+'" height="1" />'),
q-=Math.floor(parseInt(w)/4),"none"!==this.styles.text&&(k+='<text text-anchor="end" style="'+v+'" x="'+g+'" y="'+q+'">'+h+"</text>");break;default:for(d=["0.00","0.25","0.50","0.75","1.00"],n=0,C=d.length;n<C;n++)h=d[n],g=u,q=(1-parseFloat(h))*e+this.styles.top,"none"!==this.styles.grid&&(k+='<rect style="'+t+'" x="'+this.styles.left+'" y="'+q+'" width="'+f+'" height="1" />'),q-=Math.floor(parseInt(w)/4),"none"!==this.styles.text&&(k+='<text text-anchor="end" style="'+v+'" x="'+g+'" y="'+q+'">'+
...
this.BUFFER_SIZE=1024:/(Win(dows )?NT 6\.1)/.test(F)?this.BUFFER_SIZE=1024:/(Win(dows )?NT 6\.0)/.test(F)?this.BUFFER_SIZE=2048:/Win(dows )?(NT 5\.1|XP)/.test(F)?this.BUFFER_SIZE=4096:/Mac|PPC/.test(F)?this.BUFFER_SIZE=1024:/Linux/.test(F)?this.BUFFER_SIZE=8192:/iPhone|iPad|iPod/.test(F)?this.BUFFER_SIZE=2048:this.BUFFER_SIZE=16384;this.masterVolume=a.createGain();this.processor=a.createScriptProcessor(this.BUFFER_SIZE,this.NUM_INPUT,this.NUM_OUTPUT);h.prototype=Object.create(K.prototype);e.prototype=
Object.create(K.prototype);h.prototype.constructor=h;e.prototype.constructor=e;m.prototype=Object.create(e.prototype);r.prototype=Object.create(e.prototype);n.prototype=Object.create(e.prototype);p.prototype=Object.create(e.prototype);C.prototype=Object.create(e.prototype);w.prototype=Object.create(e.prototype);v.prototype=Object.create(e.prototype);t.prototype=Object.create(e.prototype);y.prototype=Object.create(e.prototype);z.prototype=Object.create(e.prototype);B.prototype=Object.create(e.prototype);
G.prototype=Object.create(e.prototype);A.prototype=Object.create(e.prototype);D.prototype=Object.create(e.prototype);m.prototype.constructor=m;r.prototype.constructor=r;n.prototype.constructor=n;p.prototype.constructor=p;C.prototype.constructor=C;w.prototype.constructor=w;v.prototype.constructor=v;t.prototype.constructor=t;y.prototype.constructor=y;z.prototype.constructor=z;B.prototype.constructor=B;G.prototype.constructor=G;A.prototype.constructor=A;D.prototype.constructor=D;this.Effector=e;this.plugins=
...
Object.prototype.toString.call(b)&&b(),x.clearInterval(c))},10);return this};h.prototype.get=function(){return this.websocket};h.prototype.toString=function(){return"[SoundModule Session]"};e.prototype.param=function(a,b){};e.prototype.connect=function(){};e.prototype.start=function(a){if(this.isActive&&this.isStop){a=parseFloat(a);if(isNaN(a)||a<this.context.currentTime)a=this.context.currentTime;this.lfo.start(a);this.isStop=!1}return this};e.prototype.stop=function(a,b){if(this.isActive&&!this.isStop){var l=
...
[];this.activeCounter=0;return this};E.prototype.params=function(){return{attack:this.attack,decay:this.decay,sustain:this.sustain,release:this.release}};E.prototype.toJSON=function(){return JSON.strignify(this.params())};E.prototype.toString=function(){return"[SoundModule EnvelopeGenerator]"};this.listener=new b(a);this.analyser=new g(a);this.recorder=new f(a,this.BUFFER_SIZE,this.NUM_INPUT,this.NUM_OUTPUT);this.session=new h(a,this.BUFFER_SIZE,this.NUM_INPUT,this.NUM_OUTPUT,this.analyser);this.eg=
...
var w,M=x.AudioContext||x.webkitAudioContext?!0:!1;K.prototype.state=function(a){};var N=function(a,c,b,g,f){if("[object Object]"===Object.prototype.toString.call(a)){var h=a;"file"in h&&(a=h.file);"type"in h&&(c=h.type);"success"in h&&(b=h.success);"error"in h&&(g=h.error);"progress"in h&&(f=h.progress)}if(a instanceof Blob){var e=new FileReader;e.onprogress=function(a){"[object Function]"===Object.prototype.toString.call(f)&&f(a)};e.onerror=function(a){if("[object Function]"===Object.prototype.toString.call(g)){var b=
"";switch(e.error.code){case e.error.NOT_FOUND_ERR:b="NOT_FOUND_ERR";break;case e.error.SECURITY_ERR:b="SECURITY_ERR";break;case e.error.ABORT_ERR:b="ABORT_ERR";break;case e.error.NOT_READABLE_ERR:b="NOT_READABLE_ERR";break;case e.error.ENCODING_ERR:b="ENCODING_ERR";break;default:b="ERR"}g(a,b)}};e.onload=function(a){if("[object Function]"===Object.prototype.toString.call(b)){var c=e.result;"[object String]"===Object.prototype.toString.call(c)&&-1===c.indexOf("data:")&&-1===c.indexOf("blob:")&&(c=
c.replace(/<(\/?script.*?)>/gi,"<$1>"));b(a,c)}};/arraybuffer/i.test(c)?e.readAsArrayBuffer(a):/dataurl/i.test(c)?e.readAsDataURL(a):/text/i.test(c)&&e.readAsText(a,"UTF-8")}else"[object Function]"===Object.prototype.toString.call(g)&&g(null,"FILE_IS_NOT_BLOB")},O=function(a,c,b,g,f){if("[object Object]"===Object.prototype.toString.call(a)){var h=a;"event"in h&&(a=h.event);"type"in h&&(c=h.type);"success"in h&&(b=h.success);"error"in h&&(g=h.error);"progress"in h&&(f=h.progress)}if(a instanceof Event){h=
null;if("drop"===a.type)a.stopImmediatePropagation(),a.preventDefault(),h=a.dataTransfer.files[0];else if("change"===a.type&&"files"in a.target)h=a.target.files[0];else return;if(h instanceof File){if(/text/i.test(c)&&-1===h.type.indexOf("text"))throw Error("Please upload text file.");if(/arraybuffer|dataurl/i.test(c)&&-1===h.type.indexOf("audio"))throw Error("Please upload audio file.");this.read({file:h,type:c,success:b,error:g,progress:f});return h}throw Error("Please upload file.");}},P=function(a,
c,b,g,f){if("[object Object]"===Object.prototype.toString.call(a)){var h=a;"url"in h&&(a=h.url);"timeout"in h&&(c=h.timeout);"success"in h&&(b=h.success);"error"in h&&(g=h.error);"progress"in h&&(f=h.progress)}var e=new XMLHttpRequest;c=parseInt(c);e.timeout=0<c?c:6E4;e.ontimeout=function(a){"[object Function]"===Object.prototype.toString.call(g)&&g(a,"timeout")};e.onprogress=function(a){"[object Function]"===Object.prototype.toString.call(f)&&f(a)};e.onerror=function(a){"[object Function]"===Object.prototype.toString.call(g)&&
g(a,"error")};e.onload=function(a){if(200===e.status){var c=e.response;c instanceof ArrayBuffer&&"[object Function]"===Object.prototype.toString.call(b)&&b(a,c)}};e.open("GET",a,!0);e.responseType="arraybuffer";e.send(null)},Q=function(a,c,b,g){a instanceof AudioContext&&c instanceof ArrayBuffer&&("[object Function]"!==Object.prototype.toString.call(b)&&(b=function(){}),"[object Function]"!==Object.prototype.toString.call(g)&&(g=function(){}),a.decodeAudioData(c,b,g))},R=function(a){var c=Math.pow(2,
1/12);Array.isArray(a)||(a=[a]);for(var b=Array(a.length),g=0,f=a.length;g<f;g++){var h=parseInt(a[g]);b[g]=0<=h?27.5*Math.pow(c,h):0}return b},S=function(a){var c=parseFloat(a);if(0<=c){a=Math.floor(c/60);var b=Math.floor(c%60),c=c-parseInt(c);return{minutes:a,seconds:b,milliseconds:c}}},T=function(a){x.X===w&&(x.X=void 0);a&&x.XSound===w&&(x.XSound=void 0);return w};E.prototype.setup=function(a,c,b,g){if("[object Object]"===Object.prototype.toString.call(a)){var f=a;"id"in f&&(a=f.id);"type"in f&&
(c=f.type);"formats"in f&&(b=f.formats);"callbacks"in f&&(g=f.callbacks)}f=String(a);c="video"!==String(c).toLowerCase()?"audio":"video";this.media=null!==a&&""!==f?document.getElementById(f):document.createElement(c);if(this.media instanceof HTMLMediaElement){Array.isArray(b)||(b=[b]);a=0;for(f=b.length;a<f;a++){var h=c+"/"+String(b[a]).toLowerCase();if(/^(?:maybe|probably)/.test(this.media.canPlayType(h))){this.ext=b[a];break}}if(""===this.ext)throw Error("Media format that can be played does not exist.");
...
(this.media[b]=Boolean(c));this[b]=Boolean(c);break;case "width":case "height":if(void 0===c)return this.media instanceof HTMLVideoElement?this.media[b]:0;g=parseInt(c);0<=g&&this.media instanceof HTMLVideoElement&&(this.media[b]=g);break;case "duration":return this.duration;case "channels":return}return this};E.prototype.ready=function(a){a=String(a);try{-1!==a.indexOf("data:")||-1!==a.indexOf("blob:")?this.media.src=a:this.media.src=a+"."+this.ext}catch(c){throw Error("The designated resource cannot be loaded.");
...
3};c in g&&(this.source.type="[object String]"===Object.prototype.toString.call(this.source.type)?c:g[c])}else if("real"in b&&"imag"in b&&(g=c=null,b.real instanceof Float32Array?c=b.real:Array.isArray(b.real)&&(c=new Float32Array(b.real)),b.imag instanceof Float32Array?g=b.imag:Array.isArray(b.imag)&&(g=new Float32Array(b.imag)),c instanceof Float32Array&&g instanceof Float32Array)){4096<c.length&&(c=c.subarray(0,4096));4096<g.length&&(g=g.subarray(0,4096));0!==c[0]&&(c[0]=0);0!==g[0]&&(g[0]=0);
var r=this.context.createPeriodicWave(c,g);this.source.setPeriodicWave(r);this.customs.real=c;this.customs.imag=g}break;case "octave":if(void 0===b)return this.octave;c=this.octave=parseFloat(b);g=(this.source.detune.minValue||-4800)/1200;r=(this.source.detune.maxValue||4800)/1200;c>=g&&c<=r&&(this.source.detune.value=this.fine+1200*c);break;case "fine":if(void 0===b)return this.fine;c=this.fine=parseFloat(b);-1200<=c&&1200>=c&&(this.source.detune.value=c+1200*this.octave);break;case "volume":case "gain":if(void 0===
b)return this.volume.gain.value;c=parseFloat(b);g=this.volume.gain.minValue||0;r=this.volume.gain.maxValue||1;c>=g&&c<=r&&(this.volume.gain.value=c)}return this};c.prototype.ready=function(a){if(this.isActive){var b=this.source.type,c=this.source.frequency.value,g=this.source.detune.value;this.isStop||(this.source.stop(this.context.currentTime),this.source.disconnect(0));this.source=this.context.createOscillator();this.source.setPeriodicWave=this.source.setPeriodicWave||this.source.setWaveTable;this.source.start=
this.source.start||this.source.noteOn;this.source.stop=this.source.stop||this.source.noteOff;"custom"===b?(b=this.context.createPeriodicWave(this.customs.real,this.customs.imag),this.source.setPeriodicWave(b)):this.source.type=b;this.source.frequency.value=c;this.source.detune.value=g;this.volume.connect(a)}return this};c.prototype.start=function(a){this.isActive?(this.source.start(a),this.isStop=!1):(this.isStop||(this.source.stop(this.context.currentTime),this.isStop=!0),this.source.disconnect(0));
return this};c.prototype.stop=function(a){this.isStop||(this.source.stop(a),this.source.disconnect(0),this.isStop=!0);return this};c.prototype.state=function(a){if(void 0===a)return this.isActive;"toggle"===String(a).toLowerCase()?this.isActive=!this.isActive:this.isActive=Boolean(a);return this};c.prototype.get=function(){return this.source};c.prototype.toString=function(){return"[OscillatorModule Oscillator]"};Array.isArray(a)||(a=[a]);for(var b=0,g=a.length;b<g;b++)this.sources[b]=new c(this.context,
Boolean(a[b])),this.eg.generators[b]=this.context.createGain(),this.eg.generators[b].gain.setTargetAtTime=this.eg.generators[b].gain.setTargetAtTime||this.eg.generators[b].gain.setTargetValueAtTime;return this};A.prototype.param=function(a,c){if("[object Object]"===Object.prototype.toString.call(a))for(var b in a)this.param(b,a[b]);else{b=String(a).replace(/-/g,"").toLowerCase();var g=v.prototype.param.call(this,b,c)}return void 0===g?this:g};A.prototype.ready=function(a,c){var b=parseFloat(a),g=
parseFloat(c);this.times.start=0<=b?b:0;this.times.stop=g>=b?g:0;return this};A.prototype.start=function(a,c,b){var g=this.context.currentTime+this.times.start;Array.isArray(a)||(a=[a]);for(var f=0,h=a.length;f<h;f++){var e=parseFloat(a[f]);a[f]=0<=e?e:0}this.eg.clear();this.processor.disconnect(0);this.processor.onaudioprocess=null;this.connect(this.processor,c);f=0;for(h=a.length;f<h&&!(f>=this.sources.length);f++)c=this.sources[f],e=a[f],c.ready(this.processor),this.eg.ready(f,c.source,c.volume),
this.glide.ready(e).start(c.source,g),c.start(g);this.eg.start(g);this.on(g);this.isAnalyser||(this.analyser.start("time"),this.analyser.start("fft"),this.isAnalyser=!0);a=this.times.stop-this.times.start;if(0<a){var m=this;x.setTimeout(function(){m.stop(b)},1E3*a)}"[object Function]"===Object.prototype.toString.call(b)?this.processor.onaudioprocess=b:this.processor.onaudioprocess=function(a){var b=a.inputBuffer.getChannelData(0),c=a.inputBuffer.getChannelData(1),e=a.outputBuffer.getChannelData(0);
a=a.outputBuffer.getChannelData(1);e.set(b);a.set(c)};return this};A.prototype.stop=function(a){var c=this.context.currentTime+this.times.stop;this.eg.stop(c);this.glide.stop();this.filter.stop(c);for(var b=0,g=this.plugins.length;b<g;b++)this.plugins[b].plugin.stop(c,this.eg.release);var f=this;"[object Function]"===Object.prototype.toString.call(a)?this.processor.onaudioprocess=a:this.processor.onaudioprocess=function(a){var b=a.inputBuffer.getChannelData(0),c=a.inputBuffer.getChannelData(1),g=
a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);g.set(b);a.set(c);if(f.eg.isStop()){b=f.context.currentTime;c=0;for(g=f.sources.length;c<g;c++)f.sources[c].stop(b);f.off(b);f.analyser.stop("time");f.analyser.stop("fft");f.isAnalyser=!1;this.disconnect(0);this.onaudioprocess=null}};return this};A.prototype.get=function(a){a=parseInt(a);return 0<=a&&a<this.sources.length?this.sources[a]:this.sources};A.prototype.length=function(){return this.sources.length};A.prototype.params=function(){var a=
v.prototype.params.call(this);a.oscillator={glide:{type:this.glide.type,time:this.glide.time}};for(var c=0,b=this.sources.length;c<b;c++){var g=this.sources[c];a.oscillator["oscillator"+c]={state:g.isActive,gain:g.volume.gain.value,type:g.source.type,octave:g.octave,fine:g.fine}}return a};A.prototype.toString=function(){return"[OscillatorModule]"};D.prototype=Object.create(v.prototype);D.prototype.constructor=D;D.prototype.setup=function(a,c,b,g,f,h){if("[object Object]"===Object.prototype.toString.call(a)){var e=
a;"resources"in e&&(a=e.resources);"settings"in e&&(c=e.settings);"timeout"in e&&(b=e.timeout);"success"in e&&(g=e.success);"error"in e&&(f=e.error);"progress"in e&&(h=e.progress)}Array.isArray(a)||(a=[a]);this.resources=a;Array.isArray(c)||(c=[c]);this.buffers.length=a.length;a=0;for(e=c.length;a<e;a++){if("buffer"in c[a])if(e=parseInt(c[a].buffer),0<=e&&e<this.buffers.length)c[a].buffer=e;else return;else return;c[a].rate="rate"in c[a]&&0<=c[a].rate?parseFloat(c[a].rate):1;c[a].loop="loop"in c[a]?
Boolean(c[a].loop):!1;c[a].start="start"in c[a]&&0<=c[a].start?parseFloat(c[a].start):0;c[a].end="end"in c[a]&&0<=c[a].end?parseFloat(c[a].end):0;c[a].volume="volume"in c[a]&&0<=c[a].volume&&1>=c[a].volume?parseFloat(c[a].volume):1;a=0;for(e=c.length;a<e;a++)this.isStops[a]=!0,this.volumes[a]=this.context.createGain(),this.eg.generators[a]=this.context.createGain(),this.eg.generators[a].gain.setTargetAtTime=this.eg.generators[a].gain.setTargetAtTime||this.eg.generators[a].gain.setTargetValueAtTime;
this.settings=c}var m=!1,r=parseInt(b),n=this;c=function(a,b){var c=new XMLHttpRequest;c.timeout=0<r?r:6E4;c.ontimeout=function(a){m||"[object Function]"!==Object.prototype.toString.call(f)||f(a,"timeout");m=!0};c.onprogress=function(a){m?c.abort():"[object Function]"===Object.prototype.toString.call(h)&&h(a)};c.onerror=function(a){m||"[object Function]"!==Object.prototype.toString.call(f)||f(a,"error");m=!0};c.onload=function(a){200===c.status&&function(c){c instanceof ArrayBuffer&&n.context.decodeAudioData(c,
function(c){n.buffers[b]=c;c=0;for(var e=n.buffers.length;c<e;c++)if(void 0===n.buffers[c])return;"[object Function]"===Object.prototype.toString.call(g)&&g.call(n,a,n.buffers)},function(a){"[object Function]"===Object.prototype.toString.call(f)&&f(a,"decode")})}.call(n,c.response)};c.open("GET",a,!0);c.responseType="arraybuffer";c.send(null)};a=0;for(e=this.resources.length;a<e;a++)"[object String]"===Object.prototype.toString.call(this.resources[a])?c.call(this,this.resources[a],a):this.resources[a]instanceof
AudioBuffer&&(this.buffers[a]=this.resources[a]);return this};D.prototype.param=function(a,c){if("[object Object]"===Object.prototype.toString.call(a))for(var b in a)this.param(b,a[b]);else{b=String(a).replace(/-/g,"").toLowerCase();var g=v.prototype.param.call(this,b,c);if(void 0!==g)return g;switch(b){case "transpose":if(void 0===c)return this.transpose;b=parseFloat(c);0<b&&(this.transpose=b)}}return this};D.prototype.ready=function(a,c){var b=parseFloat(a),g=parseFloat(c);this.times.start=0<=b?
b:0;this.times.stop=g>=b?g:0;return this};D.prototype.start=function(a,c,b){if(0<=a&&a<this.settings.length){var g=parseInt(a),f=this.settings[g].buffer,h=this.settings[g].rate,e=this.settings[g].loop,m=this.settings[g].start,r=this.settings[g].end,n=this.settings[g].volume;if(void 0!==this.buffers[f]){void 0!==this.sources[g]&&(this.sources[g].stop(this.context.currentTime),this.sources[g].disconnect(0),delete this.sources[g]);a=this.context.createBufferSource();a.start=a.start||a.noteGrainOn;a.stop=
a.stop||a.noteOff;a.buffer=this.buffers[f];a.playbackRate.value=h*this.transpose;a.loop=e;a.loopStart=m;a.loopEnd=r;this.volumes[g].gain.value=n;this.eg.ready(g,a,this.volumes[g]);this.volumes[g].connect(this.processor);this.connect(this.processor,c);c=this.context.currentTime+this.times.start;a.start(c);this.sources[g]=a;this.eg.start(c);this.on(c);this.isAnalyser||(this.analyser.start("time"),this.analyser.start("fft"),this.isAnalyser=!0);this.isStops[g]=!1;var p=this;c=this.times.stop-this.times.start;
0<c&&x.setTimeout(function(){p.stop(g)},1E3*c);a.onended=function(){p.isStops[g]=!0};"[object Function]"===Object.prototype.toString.call(b)?this.processor.onaudioprocess=b:this.processor.onaudioprocess=function(a){p.isStop=p.isStops.every(function(a,b,c){return a});if(p.isStop)p.on(p.context.currentTime),p.eg.clear(),p.analyser.stop("time"),p.analyser.stop("fft"),p.isAnalyser=!1,this.disconnect(0),this.onaudioprocess=null;else{var b=a.inputBuffer.getChannelData(0),c=a.inputBuffer.getChannelData(1),
...
AudioBuffer&&this.paused){var g=this.context.currentTime;a=parseFloat(a);this.currentTime=0<=a&&a<=this.buffer.duration?a:0;var f=this.source.playbackRate.value,h=this.source.loop;this.source=this.context.createBufferSource();this.source.start=this.source.start||this.source.noteGrainOn;this.source.stop=this.source.stop||this.source.noteOff;this.source.buffer=this.buffer;this.source.playbackRate.value=f;this.source.loop=h;this.source.connect(this.processor);this.connect(this.processor,c);this.source.start(g,
a,this.buffer.duration-a);this.analyser.start("time");this.analyser.start("fft");this.paused=!1;this.on(g);this.callbacks.start(this.source,this.currentTime);var e=this;"[object Function]"===Object.prototype.toString.call(b)?this.processor.onaudioprocess=b:this.processor.onaudioprocess=function(a){var b=a.inputBuffer.getChannelData(0),c=a.inputBuffer.getChannelData(1),f=a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);if(e.currentTime<Math.floor(e.source.buffer.duration)){for(var g=
0;g<this.bufferSize;g++)f[g]=e.vocalcanceler.start(b[g],c[g]),a[g]=e.vocalcanceler.start(c[g],b[g]),e.currentTime+=1*e.source.playbackRate.value/e.source.buffer.sampleRate,0===Math.floor(e.currentTime*e.source.buffer.sampleRate)%(.1*e.source.buffer.sampleRate)&&e.callbacks.update(e.source,e.currentTime);e.analyser.timeAllL.update(e.currentTime);e.analyser.timeAllR.update(e.currentTime)}else e.source.loop?e.currentTime=0:e.end.call(e)}}return this};z.prototype.stop=function(){if(this.buffer instanceof
...
!1);for(e in this.callbacks)this.media.addEventListener(e,function(a){m.callbacks[a.type.toLowerCase()](a,this)},!1);return this}this.media=null};B.prototype.param=function(a,c){if("[object Object]"===Object.prototype.toString.call(a))for(var b in a)this.param(b,a[b]);else{b=String(a).replace(/-/g,"").toLowerCase();var g=v.prototype.param.call(this,b,c);if(void 0!==g)return g;switch(b){case "playbackrate":if(void 0===c)return this.media instanceof HTMLMediaElement?this.media.playbackRate:this.playbackRate;
g=parseFloat(c);.5<=g&&(this.media instanceof HTMLMediaElement&&(this.media.playbackRate=g),this.playbackRate=g);break;case "currenttime":if(void 0===c)return this.media instanceof HTMLMediaElement?this.media.currentTime:0;g=parseFloat(c);if(this.media instanceof HTMLMediaElement)b=this.duration;else return;0<=g&&g<=b&&(this.media.currentTime=g);break;case "loop":case "muted":case "controls":if(void 0===c)return this.media instanceof HTMLMediaElement?this.media[b]:this[b];this.media instanceof HTMLMediaElement&&
(this.media[b]=Boolean(c));this[b]=Boolean(c);break;case "width":case "height":if(void 0===c)return this.media instanceof HTMLVideoElement?this.media[b]:0;g=parseInt(c);0<=g&&this.media instanceof HTMLVideoElement&&(this.media[b]=g);break;case "duration":return this.duration;case "channels":return this.source instanceof MediaElementAudioSourceNode?this.source.channelCount:0}}return this};B.prototype.ready=function(a){a=String(a);try{-1!==a.indexOf("data:")||-1!==a.indexOf("blob:")?this.media.src=
...
b||(this.analyser.start("time"),this.analyser.start("fft"),b=!0);"[object Function]"===Object.prototype.toString.call(f)?this.processor.onaudioprocess=f:this.processor.onaudioprocess=function(a){var b=a.inputBuffer.getChannelData(0),c=a.inputBuffer.getChannelData(1),e=a.outputBuffer.getChannelData(0);a=a.outputBuffer.getChannelData(1);for(var f=0;f<this.bufferSize;f++)e[f]=g.noisegate.start(b[f]),a[f]=g.noisegate.start(c[f])}};this.isStop=!1;navigator.getUserMedia(this.medias,function(b){g.isStop||
(f.call(g,b,a,c),g.callbacks.stream(b))},function(a){g.callbacks.error(a)});return this};F.prototype.stop=function(){this.source=null;this.off(this.context.currentTime,!0);this.analyser.stop("time");this.analyser.stop("fft");this.processor.disconnect(0);this.processor.onaudioprocess=null;this.isStop=!0;return this};F.prototype.get=function(){return this.source};F.prototype.toggle=function(a,c){this.isStreaming()?this.stop():this.start(a,c);return this};F.prototype.isStreaming=function(){return this.isStop?
!1:!0};F.prototype.params=function(){var a=v.prototype.params.call(this);a.stream={noisegate:{level:this.noisegate.level}};return a};F.prototype.toString=function(){return"[StreamModule]"};H.prototype=Object.create(v.prototype);H.prototype.constructor=H;H.prototype.mix=function(a){Array.isArray(a)||(a=[a]);this.sources=a;for(var c=0,b=this.sources.length;c<b;c++){var g=this.sources[c];if(!(g instanceof A||g instanceof D||g instanceof z||g instanceof B||g instanceof F))return;this.off(this.context.currentTime,
!1);g.analyser.stop("time");g.analyser.stop("fft");g.isAnalyser=!1;g.recorder.stop();g.session.close();g.processor.disconnect(0);g.processor.connect(this.processor)}this.connect(this.processor);this.on(this.context.currentTime);this.isAnalyser||(this.analyser.start("time"),this.analyser.start("fft"),this.isAnalyser=!0);var f=this;this.processor.onaudioprocess=function(b){var c=b.inputBuffer.getChannelData(0),g=b.inputBuffer.getChannelData(1),r=b.outputBuffer.getChannelData(0);b=b.outputBuffer.getChannelData(1);
...
arguments.length&&(b=String(a).toLowerCase(),b in this.callbacks&&"[object Function]"===Object.prototype.toString.call(c)&&(this.callbacks[b]=c));return this};t.prototype.ready=function(a,c){null!==this.source&&this.stop();this.sequences=[];this.timerids=[];this.prev=[];if(Array.isArray(a)){for(var b=0,g=a.length;b<g;b++)if(!(a[b]instanceof OscillatorNode))return;this.source=a}else if(a instanceof OscillatorNode)this.source=[a];else if(a instanceof A||a instanceof D)this.source=a;else return;for(Array.isArray(c)||
(c=[c]);0<c.length;){var f=[],h=String(c.shift()).match(t.REGEXP_MML);if(null===h){this.callbacks.error(t.ERROR_MML_STRING,"");return}for(var e=0,m=function(a,b){var c=0;switch(b){case "C":c=3;break;case "D":c=5;break;case "E":c=7;break;case "F":c=8;break;case "G":c=10;break;case "A":c=12;break;case "B":c=14;break;case "R":return"R"}c=t.EQUAL_TEMPERAMENT*(a-1)+c;return 0<=c?c:-1},r=function(a){var b=Math.pow(2,1/12);return 0<=a?27.5*Math.pow(b,a):-1};0<h.length;){var n=h.shift().trim();if(t.REGEXP_TEMPO.test(n)){var p=
...
c,b){var g=parseInt(a);if(0<=g&&g<this.sequences.length){if(!Array.isArray(this.sequences[g]))return this;if(0===this.sequences[g].length)return this.stop(b),this.callbacks.ended(),this;var f=this.sequences[g].pop();if(Array.isArray(this.source)){a=0;for(var h=this.source.length;a<h;a++){var e=this.source[a],m=e.type,r=e.detune.value,e=this.context.createOscillator();e.start=e.start||e.noteOn;e.stop=e.stop||e.noteOff;e.type=m;e.frequency.value=f.frequencies[a];e.detune.value=r;if(Array.isArray(c))for(e.connect(c[0]),
a=0,h=c.length;a<h;a++)if(m=c[a],a<h-1){r=c[a+1];if(!(m instanceof AudioNode&&r instanceof AudioNode))return;m.connect(r)}else m.connect(this.context.destination);else e.connect(this.context.destination);e.start(this.context.currentTime);e.stop(this.context.currentTime+f.duration);this.source[a]=e}a=0;for(h=f.indexes.length;a<h;a++)"R"!==f.indexes[a]&&this.callbacks.start(f,a)}else if(this.source instanceof A)for(this.source.start(f.frequencies,c,b),a=0,h=f.indexes.length;a<h;a++)"R"!==f.indexes[a]&&
