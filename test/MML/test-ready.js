describe('MML TEST', function() {
    ...
    describe('MML.prototype.ready', function() {

        it('should return the array that contains performance information', function() {
            expect(mml.ready(new Mocks.OscillatorModule, ['T74  O4  AF+DB2 AEB4 G+4 AF+C+2&AF+C+8 F+8 A8 R4']))
                      .toEqual([
                                   [
        ...
        it('should return the array that contains performance information', function() {
            expect(mml.ready(new Mocks.OscillatorModule, ['T74O4AF+DB2AEB4G+4AF+C+2&AF+C+8F+8A8R4']))
                      .toEqual([
                                   [
                                       {indexes : ['R'],            frequencies : [0],                                                                            start : 6.081081081081081,  duration : 0.8108108108108109,  stop : 6.891891891891891},
                                       {indexes : [48],             frequencies : [440.00000000000017],                                                           start : 5.675675675675675,  duration : 0.40540540540540543, stop : 6.081081081081081},
        ...
        it('should return the array that contains performance information', function() {
            expect(mml.ready(new Mocks.OscillatorModule, ['T74  O4  AF+DB2 AEB4 G+4 AF+C+2&AF+C+8 F+8 A8 R4', 'T74  O2  B2  O3  C+2 D1  O2  B2  O3  C+2 D2 E2  O2  A1 E1 F+2 E2  O3  DD1 EE1&EE1']))
                      .toEqual([
                                   [
                                       {indexes : ['R'],            frequencies : [0],                                                                            start : 6.081081081081081,  duration : 0.8108108108108109,  stop : 6.891891891891891},
                                       {indexes : [48],             frequencies : [440.00000000000017],                                                           start : 5.675675675675675,  duration : 0.40540540540540543, stop : 6.081081081081081},
        ...
        it('should return the array that contains performance information', function() {
            expect(mml.ready(new Mocks.OscillatorModule, ['T74O4AF+DB2AEB4G+4AF+C+2&AF+C+8F+8A8R4', 'T74O2B2O3C+2D1O2B2O3C+2D2E2O2A1E1F+2E2O3DD1EE1&EE1']))
                      .toEqual([
                                   [
                                       {indexes : ['R'],            frequencies : [0],                                                                            start : 6.081081081081081,  duration : 0.8108108108108109,  stop : 6.891891891891891},
                                       {indexes : [48],             frequencies : [440.00000000000017],                                                           start : 5.675675675675675,  duration : 0.40540540540540543, stop : 6.081081081081081},
